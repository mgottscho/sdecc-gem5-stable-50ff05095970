...
if [[ "$ARGC" != 3 ]]; then # Bad number of arguments. 
	...
	echo ""
	echo "USAGE: run_gem5_x86_benchmark.sh <BENCHMARK> <GEM5_CONFIG_SUBSCRIPT> <OUTPUT_DIR>"
	echo "EXAMPLE: ./run_gem5_x86_benchmark.sh bzip2 /FULL/PATH/TO/gem5-config-subscript-foo.sh /FULL/PATH/TO/output_dir"
	echo ""
