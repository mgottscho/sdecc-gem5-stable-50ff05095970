...
# Get the arguments.
ISA=$1              # String identifier for the ISA to simulate
BENCHMARK=$2		# String identifier for the SPEC CPU2006 benchmark to run
...
./run_gem5_speccpu2006_benchmark.sh $ISA $BENCHMARK $GEM5_CONFIG_SUBSCRIPT $BENCHMARK_OUTPUT_DIR
