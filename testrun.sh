...
GEM5_CONFIG_SUBSCRIPT=$PWD/subscripts/gem5-config-subscript.sh			# Full path to the gem5 config bash subscript
...
./run_gem5_x86_benchmark.sh $BENCHMARK $GEM5_CONFIG_SUBSCRIPT $BENCHMARK_OUTPUT_DIR
